...
@section('title')
    <title>E-Commerce - Bukti Bayar</title>
@endsection
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <img src="{{ asset('storage/images/bukti-bayar-produk/'. $item->bukti_bayar) }}" alt="" class="img-fluid">
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">{{ rupiah($item->total_harga) }}</th>
                ...
                @if ($item->status_bayar == 'menunggu-konfirmasi')
                    <a href="{{ route('e-commerce.konfirmasi-pembayaran', $item->id) }}" class="btn btn-primary btn-block">Konfirmasi Pembayaran</a>
                @else
