...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('serba-serbi.update', $item->id) }}" method="POST" class="">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="serba_serbi">Serba-Serbi</label>
                        <textarea name="serba_serbi" id="serba_serbi" cols="30" rows="100" class="ckeditor form-control @error('serba_serbi') is-invalid @enderror">{!! $item->serba_serbi !!}</textarea>
                        @error('serba_serbi')
