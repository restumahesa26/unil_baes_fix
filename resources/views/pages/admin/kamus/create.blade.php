...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('kamus.store') }}" method="POST" class="" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="kata_kunci">Kata Kunci</label>
                        <input type="text" name="kata_kunci" class="form-control @error('kata_kunci') is-invalid @enderror" id="kata_kunci" placeholder="Masukkan Kata Kunci" value="{{ old('kata_kunci') }}" required>
                        @error('kata_kunci')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="terjemahan" class="form-control @error('terjemahan') is-invalid @enderror" id="terjemahan" placeholder="Masukkan Terjemahan" value="{{ old('terjemahan') }}" required>
                        @error('terjemahan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
