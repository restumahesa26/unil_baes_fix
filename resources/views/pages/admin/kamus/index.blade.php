            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Kamus</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="page-content">
    <div class="card">
        <div class="card-header">
            <a href="{{ route('kamus.create') }}" class="btn btn-primary">Tambah Kamus</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" width="100%" cellspacing="0" id="table">
                    ...
                    <tbody id="tbody">
                        ...
                        <tr class="text-center">
                            ...
                            <td>{{ $item->terjemahan }}</td>
                            <td>
                                <a href="{{ route('kamus.edit', $item->id) }}" class="btn btn-primary">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="{{ route('kamus.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('delete')
