    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="pekerjaan" class="block mt-1 w-full" type="text" name="pekerjaan" :value="old('pekerjaan')" required autofocus autocomplete="pekerjaan" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="no_hp" class="block mt-1 w-full" type="no_hp" name="no_hp" :value="old('no_hp')" required />
            </div>
